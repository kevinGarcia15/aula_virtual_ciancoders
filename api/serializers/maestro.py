...
#serilizer
from api.serializers import ProfileSerializer, ProfileAndUserSerializer, CreateProfileSerializer, ActualizarProfileSerializer
...
class ActualizarMaestroSerializer(serializers.ModelSerializer):
